        ...
        <section class="mt-10">
            <form class="flex flex-col" method="get" action="login">
                ...
                <div class="mb-6 pt-3 rounded bg-gray-200">
                    ...
                    <input type="text" id="email" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-themegreen transition duration-500 px-3 pb-3">
                </div>
                <div class="mb-6 pt-3 rounded bg-gray-200">
                    <label class="block text-gray-700 text-sm font-bold mb-2 ml-3" >Password</label>
                    <input type="password" id="password" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-themegreen transition duration-500 px-3 pb-3">
                </div>
