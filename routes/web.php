...
Route::get('/', [LoginController::class, 'toHome'])->name('/');
Route::get('/dashboard', [LoginController::class, 'showUser'])
    ->middleware('auth')
    ->middleware('crosscheck')
    ->name('dashboard');
Route::get('/demonlord', [LoginController::class, 'showAdmin'])
    ->middleware('auth')
    ->middleware('crosscheck')
    ->name('demonlord');
